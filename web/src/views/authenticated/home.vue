    ...
    <div class="container">
      <section class="section">
        ...
        <div v-if="notes !== '' || canUserAccountAdmin === true" class="my-4">
          ...
          <b-message v-if="notes !== ''" type="is-primary">
            <span v-for="line in notesSplit" :key="line">
              {{ line }}
              <br />
            </span>
          </b-message>
        ...
        <div v-if="!pageLoading">
          <div v-if="lists.length > 0">
            ...
            <p class="is-size-5 ml-3 mb-2">
              <b-icon icon="party-popper" type="is-success" size="is-medium" />
            ...
            <div class="card-content card-content-list">
              <div class="media">
                <div class="media-left">
                  <b-icon icon="account-group" size="is-medium" />
                </div>
