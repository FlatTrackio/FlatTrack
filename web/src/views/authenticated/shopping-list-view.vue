...
export default {
  ...
  computed: {
    ...
    totalItems() {
      return this.listFull === null ? 0 : this.listFull.length;
    },
    ItemId() {
  ...
  methods: {
    ...
    transformShoppingListItems(responseList) {
    ...
    GetShoppingListItems() {
      ...
      shoppinglist
        ...
        .then((resp) => {
          this.listFull = resp.data.list || [];
        });
    },
    GetShoppingListItemsFromWS(evt) {
      this.listFull = JSON.parse(evt.data).list || [];
    },
