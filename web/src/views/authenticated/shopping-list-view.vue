        ...
        <div v-if="editingMeta">
          <b-field label="Name">
            <b-input
              ...
              required
              @keyup.enter="UpdateShoppingList"
              @keyup.esc="
                editing = false;
                editingMeta = false;
              "
        ...
        <b-field>
          ...
          <p class="control">
            ...
            >
              ...
              <option value="highestQuantity">
                Highest Quantity
              </option>
              <option value="lowestQuantity">
                Lowest Quantity
              </option>
        ...
        <div>
          <section>
            <b-modal
              ...
              :can-cancel="false"
            >
              <shoppinglistItemNew v-bind="newItemProps" />
            </b-modal>
            <b-modal
              ...
              :can-cancel="false"
            >
              <shoppinglistItemEdit v-bind="editItemProps" />
            </b-modal>
          </section>
          <section>
            <div
        ...
        <div v-if="listItemsFromTags.length > 0">
          ...
          <div v-if="sortBy === 'tags'">
            ...
            >
              ...
              >
                <div
                  v-for="(item, index) in itemTag.items"
                  :key="item"
                >
                  <a :id="item.id" />
                  <itemCard
