      ...
      <section class="section">
        <nav class="breadcrumb is-medium has-arrow-separator" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="is-active"><router-link :to="{ name: 'View shopping list item', params: { listId: shoppingListId, itemId: id } }">{{ name || 'Unnamed item' }}</router-link></li>
            </ul>
        </nav>
        <div>
          ...
          <p>
            Added {{ TimestampToCalendar(creationTimestamp) }}, by <router-link tag="a" :to="{ name: 'My Flatmates', params: { author } }"> {{ authorNames }} </router-link>
          ...
          <p v-if="creationTimestamp !== modificationTimestamp">
            Last updated {{ TimestampToCalendar(modificationTimestamp) }}, by <router-link tag="a" :to="{ name: 'My Flatmates', params: { authorLast } }"> {{ authorLastNames }} </router-link>
          </p>
        </div>
      </section>
    </div>
